...
In combination with its Berserk special, it is considered to be the strongest shot weapon in the game.

## Known issues

- Firing three D-Virus Launchers at the same time may cause crashes to some clients in a room. This is an especially prevalent issue in [Respective Tomorrow](/quests/respective-tomorrow) as it's a commonly used weapon against [Olga Flow (phase 2)](/enemies/olga-flow).
- Probably because of the slow nature of the projectiles, this weapon tends to not work well against moving enemies that are too far.
