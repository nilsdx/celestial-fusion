...
description: A ghastly shotgun with exceptional range. Its special attack fires highly lethal bullets which can send your enemies to their graves.
---
# Grave Digger

## Set Effects

Note: both Grave Digger and Nefarious Needle can benefit from set effects

| Item | Effect |
| ----------- | ----------- |
| [Vector Scope](/units/vector-scope) | ATP+60, ATA+30 |

## Variants

Grave Digger has a cosmetic variant that can be acquired by combining it with another item to make Nefarious Needle.
